...
<html>
  ...
  <body>
	...
	<form id="tf" action="<%=basePath%>category/submit" method="post" class="form-horizontal"
		enctype="multipart/form-data">
			<div class="modal-body">
				<div class="form-group">
    				<label for="inputEmail3" class="col-sm-2 control-label">cid</label>
    				<div class="col-sm-10">
